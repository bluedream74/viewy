...
from .views import (Account, RecordUserStats, GetUserStats, UserAnalytics, Partner, RandomRecommendedUsers, UpdateBoostTypeView, Post, Hashtag, Ad, KanjiRegist, KanjiDelete, PosterWaiterList, AddToPosterGroup, RemoveFromWaitList, SearchEmailandAddPoster, ClickCountView)
from . import views
